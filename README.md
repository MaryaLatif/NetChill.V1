...
--------------------
Just run the `com.netchill.WebApplication` class, you can then open your browser to <http://localhost:8080>.
...
you can run the `com.netchill.db.QuerydslGenerator.main()` method.
			...
			<configuration>
				<transformers>
					...
					<transformer
						...
						<mainClass>com.netchill.WebApplication</mainClass>
					</transformer>
				</transformers>
			</configuration>
		</execution>

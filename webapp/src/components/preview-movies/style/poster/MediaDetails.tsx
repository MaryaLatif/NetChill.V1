...
function MediaDetails({ id_serie, genre_ids, title, overview, onClickButton }: {
  id_serie: number,
  genre_ids: number[],
  title: string,
  overview: string,
  ...
  return (
    <div id="info">
      ...
      {
        episodesVisible &&
        <EpisodesPopin mediaId={id_serie} mediaType={MediaType.SERIE} overview={overview} genreIds={genre_ids}
                       onClose={() => {
                         onClose;
                       }} />
      }
